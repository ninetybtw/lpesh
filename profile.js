...
const PLAN_FEATURES = {
  ...
  pro: {
    monthly: ['Все конспекты и карточки без ограничений', '5 попыток теста в день с разбором', 'Пробный экзамен — 3 попытки в месяц', 'ИИ-консультант — 5 запросов в день, проверка эссе — 2/мес', 'Дуэли — 3/день, турниры — 1/мес без взноса', 'Публикация своих тестов и статей (после модерации)', 'Без рекламы'],
