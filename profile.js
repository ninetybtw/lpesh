...
const PLAN_FEATURES = {
  ...
  pro: ['Все конспекты и карточки без ограничений', '5 попыток теста в день с разбором', 'Пробный экзамен — 3 попытки в месяц', 'ИИ-консультант, дуэли — 3/день, турниры — 1/мес без взноса', 'Публикация своих тестов и статей (после модерации)', 'При оплате на год — продвинутый ИИ-консультант с загрузкой файлов'],
  max: ['Всё из «Про» без лимитов', 'ИИ-консультант — 35 запросов в день', 'Безлимит: пробные экзамены, дуэли', 'Турниры — до 5 участий в месяц без взноса', 'Экспорт конспектов в PDF', 'При оплате на год — продвинутый ИИ-консультант с загрузкой файлов']
};
